 ...
 *  interp_quad_chi()       -- 2nd order rep. of opacity with slope lim.
 ...
 */
   ...
   (*chi) = 0.4166666666666667 * chi0 + 0.6666666666666667 * chi1 -
            0.0833333333333333 * chi2;
...
/*----------------------------------------------------------------------------*/
/* \fn void interp_quad_source_slope_lim(Real dtaum, Real dtaup, Real *edtau,
 *                                       Real *a0, Real *a1, Real *a2, Real S0, 
 *                                       Real S1, Real S2)
 ...
 *                             Real *a1, Real *a2)
 *  Computes quadrature weights for integration of the radiation transfer eq.
 *  along one ray in one gridzone using quadratic interpolation.  Retained only
...
/*----------------------------------------------------------------------------*/
/*! \fn void interp_quad_chi_new(Real chi0, Real chi1, Real chi2, Real *chi12, 
 *                               Real *chi32)
 *  Experimental version of interp_quad_chi() */
void interp_quad_chi_new(Real chi0, Real chi1, Real chi2, Real *chi12,
                         Real *chi32)
{
  ...
  if ((chi0-chic12)*dchi <= 0.0) {
    (*chi12) = 0.4166666666666667 * chi0 + 0.6666666666666667 * chi1 -
               0.0833333333333333 * chi2;
    /* chic = chi1 */
  } else {
  ...
  if ((chic32-chi2)*dchi <= 0.0) {
    (*chi32) = 0.4166666666666667 * chi2 + 0.6666666666666667 * chi1 -
               0.0833333333333333 * chi0;
    /* chic = chi1 */
  } else {
