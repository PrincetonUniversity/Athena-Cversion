...
/* Only do this with shearing box, as this only seems to  */
/* cause trouble in shearing box */
#if defined(MPI_PARALLEL) && defined(SHEARING_BOX)
...
#endif /* MPI_PARALLEL  AND SHEARING_BOX */
